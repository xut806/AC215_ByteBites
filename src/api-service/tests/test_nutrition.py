...
def test_get_nutritional_info():
    with mock.patch('api.routers.nutrition.get_nutrition_info') as mock_get_nutrition_info, \
         mock.patch('api.routers.nutrition.aggregate_nutrition_info_with_units') as mock_aggregate_nutrition_info:
