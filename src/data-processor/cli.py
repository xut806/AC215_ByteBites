...
def formatting_prompt(examples):
    ...
    data_prompt = """Write a recipe that includes clear instructions and ingredients. Ensure the recipe has a detailed list of ingredientsand step-by-step cooking instructions.
...
def main():
    ...
    split_data = DatasetDict({"train": train_data, "validation": val_data})
    
    print('Uploading train and val data...')
    upload_to_gcp(train_data, bucket_name, "processed/fine_tuning_llama_train_data.jsonl")
