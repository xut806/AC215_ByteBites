            ...
            <>
              {navigation.map((item, index) => (
                <Link
                  key={index}
                  href={item.href}
                  className="w-full px-4 py-2 -ml-4 text-gray-500 rounded-md dark:text-gray-300 hover:text-pink-500 focus:text-pink-500 focus:bg-pink-100 dark:focus:bg-gray-800 focus:outline-none"
                >
                  {item.text}
                </Link>
              ))}
              <Link
                ...
                className="w-full px-6 py-2 mt-3 text-center text-white bg-pink-600 rounded-md lg:ml-5"
              >
                {cta.text}
              </Link>
            </>
